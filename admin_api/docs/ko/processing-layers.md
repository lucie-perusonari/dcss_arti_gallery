...
- 모듈: `admin_api/`
- 역할: MongoDB crawl 상태/Artifact 처리 상태 컬렉션과 내부 Prometheus API를 읽어 admin dashboard가 사용할 HTTP API를 제공한다.
...
- `admin_api.repository`: MongoDB crawl 상태와 artifact processing 상태 read repository
