...
Admin API endpoint에서 crawl file/user/raw file 상태와 Gallery API metrics를 읽어 운영 상태를 보여줍니다.
...
- Admin API endpoint에서 crawl file/user/raw file 상태와 Gallery API metrics를 읽습니다.
...
Grafana 링크를 표시하려면 frontend 실행 또는 build 환경에 `VITE_GRAFANA_URL`을 지정합니다.
